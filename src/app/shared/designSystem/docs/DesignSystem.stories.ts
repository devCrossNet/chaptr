...
story.add(
  ...
  withInfo({
    ...
    template: `<vue-markdown :use-router="false">
## Typography
Lato is the standard type face for the Design System blueprint.
...
H1             | 4.8rem      | $font-weight-light
H2             | 3.2rem      | $font-weight-light
H3             | 2.4rem      | $font-weight-light
H4             | 2rem        | $font-weight-light
H5             | 1.6rem      | $font-weight-light
H4             | 1.6rem      | $font-weight-light
...
tabletPortrait   | 768px    | 767px    | 1.6rem
tabletLandscape  | 1024px   | 1023px   | 1.6rem
smallDesktop     | 1280px   | 1279px   | 1.6rem
largeDesktop     | 1440px   | 1439px   | 1.6rem
</vue-markdown>
`,
  })),
);
